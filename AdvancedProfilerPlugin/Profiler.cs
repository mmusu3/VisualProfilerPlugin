...
public sealed class ProfilerTimer : IDisposable
{
    ...
    internal void StartEvent(long startTime)
    {
...
public static class Profiler
{
    ...
    {
        var tg = new ProfilerGroup(name, thread: null);
        int groupId = 0;
